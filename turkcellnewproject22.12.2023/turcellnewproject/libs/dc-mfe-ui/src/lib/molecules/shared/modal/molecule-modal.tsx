...
export function MoleculeModal(props: ModalProps) {
  ...
  const bodyTextClasses = classnames('text-captions-regular', [
    ...
    {
      [styles[`m-trkclAppModal__bodyText--${type}`]]: type,
    },
  ]);
  ...
  const contentClasses = classnames([
    styles['m-trkclAppModal__content'],
    contentClassName,
  ]);

  const buttonClasses = classnames([
    styles['m-trkclAppModal__button'],
    buttonClassName,
  ]);
  ...
  return (
    <AtomModal
      ...
      backgroundClassNameToParent={backgroundClassName}
      header={
