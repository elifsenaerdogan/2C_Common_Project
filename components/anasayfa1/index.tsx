...
import styles from "./anasayfa1.module.scss";
            ...
            <div className={styles.dis}>
                ...
                <div className={styles.en1}>
                    <div className={styles.ikyaz1}>
                        ...
                        <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Kullanıcı İşlemleri</h1>
                    </div>
                ...
                <div className={styles.en1}>
                    <div className={styles.ikyaz1}>
                        ...
                        <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Depo İşlemleri</h1>
                    </div>
                    <div className={styles.altalt}>
                        <div className={styles.linkdiv1}>
                            <Link href= "/depo">
                ...
                <div className={styles.en1}>
                    <div className={styles.ikyaz1}>
                        ...
                        <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Kategoriler</h1>
                    </div>
                    <div className={styles.altalt}>
                        <div className={styles.linkdiv1}>
                ...
                <div className={styles.en1}>
                    <div className={styles.ikyaz1}>
                        ...
                        <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Ürünler</h1>
                    </div>
                    <div className={styles.altalt}>
                        <div className={styles.linkdiv1}>
                            <Link href= "a">
                ...
                <div className={styles.har1}>
                    ...
                    <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Mal Kabul/Sevkiyat <br/> İşlemleri</h1>
                </div>
                ...
                <div className={styles.en1}>
                    <div className={styles.ikyaz1}>
                        ...
                        <h1 style={{ whiteSpace: 'nowrap' }} className={styles.yazi1}>Araç İşlemleri</h1>
                    </div>
                    <div className={styles.altalt}>
                        <div className={styles.linkdiv1}>
                            <Link href= "a">
