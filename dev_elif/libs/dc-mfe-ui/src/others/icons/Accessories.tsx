...
const SvgAccessories = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 64 64' {...props}>
    <g fill='none' fillRule='evenodd'>
      ...
      <g transform='translate(15 15)'>
        ...
        <path stroke='#FFC900' strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M9.818 11H3.46A3.46 3.46 0 0 0 0 14.46v11.414a3.46 3.46 0 0 0 3.46 3.46h11.08A3.46 3.46 0 0 1 18 32.792V37' />
