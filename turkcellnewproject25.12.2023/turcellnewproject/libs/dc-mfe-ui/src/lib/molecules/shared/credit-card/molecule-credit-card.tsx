...
export function CreditCard(props: CardProps) {
  ...
  const ContentClassNames = classNames(styles['m-credit-card__content'], {
    [styles['m-credit-card__content-dark']]: cardNumber?.length > 6,
  });
      ...
      <div className={ContentClassNames}>
        <Row className={FrontSideClassNames}>
          ...
          <Col span={8} className={IconSectionClassNames}>
            <Row justify="end">
              {bankLogo &&
                !bankLogo?.includes('null') &&
                !bankLogo?.includes('undefined') && (
                  <AtomImage
                    src={bankLogo}
            ...
            <Row justify="end">
              {cardTypeLogo &&
                !cardTypeLogo?.includes('null') &&
                !cardTypeLogo?.includes('undefined') && (
                  <AtomImage
                    src={cardTypeLogo}
