  ...
  const handleFocus = () => {
    ...
    const onSubmit = (data, inputValue) => {
        if(isChecked1){
          ...
          useBySimNumberService(inputValue, gsmno, simNumber, captchaData.identifier);
        }else if(isChecked2){
          // eslint-disable-next-line react-hooks/rules-of-hooks
          useByTcNumberService(inputValue, gsmno, simNumber, captchaData.identifier, birthDay, birthMonth, birthYear)
        }
    };
