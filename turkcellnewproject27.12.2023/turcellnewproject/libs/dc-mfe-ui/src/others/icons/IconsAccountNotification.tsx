...
const SvgIconsAccountNotification = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width='1em' height='1em' viewBox='0 0 30 30' {...props}>
    <defs>
      <circle id='icons-account-notification_svg__c' cx={12} cy={12} r={4} />
      <path
        id='icons-account-notification_svg__a'
    ...
    <g fill='none' fillRule='evenodd'>
      <g transform='translate(2 2)'>
        <mask id='icons-account-notification_svg__b' fill='#fff'>
          <use xlinkHref='#icons-account-notification_svg__a' />
        </mask>
        <g fill='currentColor' mask='url(#icons-account-notification_svg__b)'>
          <path d='M-2-2h24v24H-2z' />
        </g>
      </g>
      <g transform='translate(6 6)'>
        <mask id='icons-account-notification_svg__d' fill='#fff'>
          <use xlinkHref='#icons-account-notification_svg__c' />
        </mask>
        <g fill='#FFC900' mask='url(#icons-account-notification_svg__d)'>
...
export default SvgIconsAccountNotification
