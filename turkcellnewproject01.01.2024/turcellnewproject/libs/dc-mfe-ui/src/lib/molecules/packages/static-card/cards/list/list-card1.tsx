...
export function ListCard1(props: MoleculesStaticCardProps) {
  ...
  const content = classNames(styles['m-trkclStatic1__content']);
        ...
        <div className={packageDetail}>
          <div>
            <div className={monthly}>
              {staticObject?.gb}
              <span className={classNames('text-body-large-regular')}>
                {staticObject?.gbText}
              </span>
            </div>
          </div>
