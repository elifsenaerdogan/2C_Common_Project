...
const Story: Meta<typeof MoleculeFastActions> = {
  component: MoleculeFastActions,
  title: 'Molecules/FastActions',
};
    ...
    >
      <MoleculeFastActions
        ...
        popularTransactions={[
          ...
          {
            icon: (
              <AtomIcon icon={<IconsTl width={'100%'} height={'100%'} />} />
            ),
            url: '',
            text: 'TL Yükle',
