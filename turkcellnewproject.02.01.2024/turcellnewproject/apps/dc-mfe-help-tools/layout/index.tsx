                    ...
                    <div className={styles.pukCodePageP}>
                        <div>
                            <div className={styles.pukCodePageWritesIII}>
                                ...
                                <p className={pukCodePageWriteII}>
                                    {!isVisiblePageResponseWithTc && !isVisiblePageResponseWithSc
                  ...
                  <>
                    <div>
                        ...
                        <div className={styles.PukPageResponse}>
                            <div>
                                <p>{pageManagerData?.labelDTOList["helptools.pukcode.response.puk1"]}</p>
                            </div>
                            <div>
                                <p>{pageManagerData?.labelDTOList["helptools.pukcode.response.puk1.label"]}</p>
                            </div>
                            <div>
                                <p>{pageManagerData?.labelDTOList["helptools.pukcode.response.puk2"]}</p>
                            </div>
                            <div>
                                <p>{pageManagerData?.labelDTOList["helptools.pukcode.response.puk2.label"]}</p>
                            </div>
