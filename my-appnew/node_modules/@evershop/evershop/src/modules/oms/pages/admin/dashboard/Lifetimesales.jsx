        ...
        <Card.Session>
          <div className="grid grid-cols-1 gap-1">
            <div className="flex space-x-1 items-center">
              <Dot variant="info" />
              <div className="self-center">{orders} {t('orders')}</div>
            </div>
            <div className="flex space-x-1 items-center">
              <Dot variant="info" />
              <div className="self-center">{total} {t('lifetimesales')}</div>
            </div>
            <div className="flex space-x-1 items-center">
              <Dot variant="success" />
              <div className="self-center">
                {completed_percentage}% {t('comploted')}
              </div>
            </div>
            <div className="flex space-x-1 items-center">
              <Dot variant="critical" />
              <div className="self-center">
                {cancelled_percentage}% {t('cancelled')}
              </div>
            </div>
          </div>
        </Card.Session>
