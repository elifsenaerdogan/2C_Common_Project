...
const Layout = () => {
  ...
  const getPukSimData = useGetPukWithSc(gsmno,simNumber, captchaData?.identifier,inputValue);
  const getPukTcData = useGetPukWithTc(gsmno,tckn,birthDay,birthMonth,birthYear, captchaData?.identifier, inputValue);
  ...
  const pukCodePageWriteII = classNames(
    ...
    styles.trkcellpukCodePageWriteII
  );
  const pukCodePageWriteI = classNames(
    'text-body-regular-medium',
    styles.trkcellpukCodePageWriteI
  );
  ...
  return (
    <>
      ...
      <div className={styles.pukCodePage}>
        ...
        {!isVisiblePageResponse && pageManagerData && (
          <div className={styles.pukCodePageP}>
            <div>
              <div className={styles.pukCodePageWritesIII}>
                <p className={pukCodePageWriteI}>{pageManagerData.labelDTOList["helptools.pukcode.title.page"]}</p>
                ...
                <AtomRadioButton
                  ...
                  element={<div className={styles.pukCodePageSimIconText}>
                    ...
                    <div className={styles.pukCodePageSim}>
                      ...
                      <p className={pukCodePageSimII} style={{ whiteSpace: 'nowrap' }}>{pageManagerData.labelDTOList["helptools.pukcode.label.simcard"]}</p>
                    </div>
                  </div>}
                  value="isChecked1"
                ...
                <AtomRadioButton
                  ...
                  element={<div className={styles.pukCodePageTcIconText}>
                    ...
                    <div className={styles.pukCodePageTc}>
                      ...
                      <p className={pukCodePageTcII} style={{ whiteSpace: 'nowrap' }}>{pageManagerData.labelDTOList["helptools.pukcode.label.withidnumber"]}</p>
                    </div>
                  </div>}
                  value="isChecked2"
