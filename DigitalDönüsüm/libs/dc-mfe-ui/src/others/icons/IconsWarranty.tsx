...
const SvgIconsWarranty = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width='1em' height='1em' viewBox='0 0 24 24' {...props}>
    ...
    <g fill='none' fillRule='evenodd'>
      <mask id='icons-warranty_svg__b' fill='#fff'>
        <use xlinkHref='#icons-warranty_svg__a' />
      </mask>
      <use xlinkHref='#icons-warranty_svg__a' fill='#979797' fillRule='nonzero' />
      <g fill='currentColor' mask='url(#icons-warranty_svg__b)'>
        <path d='M0 0h24v24H0z' />
      </g>
    </g>
  </svg>
)
export default SvgIconsWarranty
